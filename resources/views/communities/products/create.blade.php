...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <h5 class="mb-0 h6">{{translate('Add Community Product')}}</h5>
</div>
<div class="">
    <form class="form form-horizontal mar-top" action="{{route('community_product_store')}}" method="POST" enctype="multipart/form-data" id="choice_form">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control aiz-date-range" name="purchase_date_range" placeholder="{{translate('Purchase Date Range')}}" data-time-picker="true" data-format="DD-MM-YYYY HH:mm:ss" data-separator=" TO " autocomplete="off" required>
                            </div>
                        </div>
