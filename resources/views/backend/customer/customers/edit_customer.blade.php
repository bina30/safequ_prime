...
@section('content')
    ...
    <div class="">
        <form class="form form-horizontal mar-top" action="{{route('customers.update_customer')}}" method="POST"
                                ...
                                <div class="col-md-8">
                                    <select class="form-control aiz-selectpicker" name="community_id" id="community_id"
                                        ...
                                        @foreach ($sellers as $seller)
                                            <option value="{{ $seller->user->id }}" @if($seller->user->id == $user->joined_community_id) selected @endif >
                                                {{ $seller->user->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8 phone-form-group">
                                    <input type="tel" id="phone-code" required maxlength="10" minlength="10"
                                           ...
                                           value="{{ $user->phone }}" placeholder="" name="phone" autocomplete="off">
                                </div>
                            </div>
                            <div class="form-group row">
