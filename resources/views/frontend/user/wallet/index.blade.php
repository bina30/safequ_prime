                    ...
                    <div class="trans-history pt-4 mt-3">
                        ...
                        <div class="pt-4">
                            @forelse ($wallets as $key => $wallet)
                                <div
                                    class="transactions cursor-pointer flex-wrap @if ($wallet->amount > 0) credit @else debit @endif">
                                    ...
                                    <div class="w-100 transDetails">
                                        <div class="pt-2 px-2">
                                            <p class="body-txt mb-1"><span class="fw500 fsize13">Payment method:</span>
                                                Razorpay</p>
                                            <p class="body-txt mb-1"><span class="fw500 fsize13">Transection id:</span>
                                                #tst_5214-21523</p>
                                        </div>
                                    </div>
                                </div>
